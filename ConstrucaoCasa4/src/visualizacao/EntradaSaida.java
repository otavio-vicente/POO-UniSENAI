...
public class EntradaSaida {
	...
	public static String solicitaTipoAbertura() {
		...
		int tipoAbertura = JOptionPane.showOptionDialog(null, "Informe qual tipo de abertura deseja mover", "Mover aberturas", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[0]);
	...
	public static int solicitaAberturaMover(ArrayList<Aberturas> listaDeAberturas) {
		...
		tipoAbertura = tipoAbertura.toLowerCase();
